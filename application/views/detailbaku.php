    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-3">
                    <?php if ($id != null) { ?>
                        <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('baku/detail/' . $id->id_baku); ?>" method="post">
                        <?php } ?>
                ...
                <div class="col-3">
                    ...
                    <?php if ($id != null) { ?>
                        <a href="<?php echo site_url('baku/v_detail/' . $id->id_baku); ?>" class="btn btn-success btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                    <?php } else {
                            ...
                            foreach ($filter as $t) { ?>
                                <tr>
                                    ...
                                    <td class="td-actions text-center">
                                        <button type="button" onclick="ganti(<?php echo $t->id_tb; ?>)" rel="tooltip" class="btn btn-success btn-round" data-original-title="" title="">
