    ...
    <div class="card">
        <div class="card-body">
            <div>
                <div class="row">
                    <div class="col-3">
                        <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('InputBaku/'); ?>" method="post">
                    ...
                    <div class="col-3">
                        ...
                        <a href="<?php echo site_url('InputBaku/v_index'); ?>" class="btn btn-success btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                    </div>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <?php if ($this->session->userdata('level') == "superadmin") { ?>
                                        <td class="td-actions text-right">
                                            <button type="button" onclick="ganti(<?php echo $k->id_input; ?>)" rel="tooltip" class="btn btn-success btn-round" data-original-title="" title="">
                                                <i class="zmdi zmdi-edit zmdi-hc-fw"></i>
                                            </button>
                                            &nbsp;
                                            <button type="button" rel="tooltip" class="btn btn-danger btn-round" data-original-title="" title="" onclick="hapus(<?php echo $k->id_input; ?>)">
