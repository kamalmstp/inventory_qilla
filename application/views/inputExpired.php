    ...
    <div class="card">
        <div class="card-body">
            <div>
                <div class="row">
                    <div class="col-3">
                        <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('InputExpired/'); ?>" method="post">
                    ...
                    <div class="col-3">
                        ...
                        <a href="<?php echo site_url('InputExpired/v_index'); ?>" class="btn btn-success btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                    </div>
                </div>
            </div>
