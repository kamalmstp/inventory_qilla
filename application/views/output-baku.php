<section class="content">
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-3">
                    <form class="navbar-form navbar-left" role="search" action="<?php echo site_url('OutputBaku/'); ?>" method="post">
                        <div class="form-group">
                            <input class="form-control" type="date" name="start" value="<?php echo $this->session->userdata('startSession') ?>" required>
                        </div>
                </div>
                <div class="col-3">
                    <div class="form-group">
                        <input class="form-control" type="date" name="end" value="<?php echo $this->session->userdata('endSession') ?>" required>
                    </div>
                </div>
                <div class="col-3">
                    ...
                    <a href="<?php echo site_url('OutputBaku/v_index'); ?>" class="btn btn-success btn-sm"><i class="fas fa-sync-alt"></i> Reset</a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <?php if ($this->session->userdata('level') == 'superadmin') { ?>
                                        <td class="td-actions text-center">
                                            <button type="button" onclick="ganti(<?php echo $k->id_output; ?>)" rel="tooltip" class="btn btn-success btn-round" data-original-title="" title="">
                                                <i class="zmdi zmdi-edit zmdi-hc-fw"></i>
                                            </button>
                                            &nbsp;
                                            <button type="button" rel="tooltip" class="btn btn-danger btn-round" data-original-title="" title="" onclick="hapus(<?php echo $k->id_output; ?>)">
